...
if __name__ == "__main__":
    Gui = DropletGui()
    list_of_defaults: list[float] = Gui.read_defaults()
    list_of_inputs = [("X cord. of the Y-line", list_of_defaults[0], "mm"),  # 0
                      ("Y cord. of the X-line", list_of_defaults[1], "mm"),  # 1
                      ("First Spot X-offset", list_of_defaults[2], "mm"),  # 2
                      ("First Spot Y-offset", list_of_defaults[3], "mm"),  # 3
                      ...
                      ("Loading from", list_of_defaults[9], "1 or 2 "),  # 9
                      ("Leftovers into", list_of_defaults[10], "3 or 4"),  # 10
                      ("Z-Adjust down", list_of_defaults[11], "mm"),  # 11
                      ("droplet forming time", list_of_defaults[12], "s"),  # 12
                      ("number of grids", list_of_defaults[13], "1 or 2"),  # 13
